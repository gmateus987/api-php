...
<body class="h-screen flex flex-col items-center justify-center bg-[url('/api/public/assets/main-bg.png')] bg-cover p-7">

  <div class="shadow-md rounded px-8 pt-6 pb-8 mb-4 w-full max-w-md bg-zinc-800 text-white">
    <form id="form" name="form">
      ...
      <div class="mb-4">
        ...
        <input class="shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline" id="name" name="name" type="text" placeholder="Enter your username">
      </div>
      <div class="mb-4">
      ...
      <div class="flex items-center justify-between">
        ...
        <a class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800" href="/api/login">
  ...
  <script src="/api/public/js/register.js"></script>
